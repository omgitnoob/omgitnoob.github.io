...
IsSubmitPress.addEventListener("click", function(){checkInput(); console.log("checking")})
...
function ResetQuiz()
{
    ...
    for (i = 1; i <= QuizAnsArray.length; i++)
    {
...
document.getElementById('GameBoard').addEventListener('mousemove', function (mouse)
{
    ...
    setTimeout(() => 
    {
        ...
        setTimeout(() => {WaterDroplet.remove();}, 1500); // remove the waterdroplet after 1 sec
    },500);
});
